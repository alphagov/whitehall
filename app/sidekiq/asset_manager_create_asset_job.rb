class AssetManagerCreateAssetJob < JobBase
  ...
  # might not be committed yet. This can cause a race condition where the job runs before the assetable is readable.
  # Use TransactionAwareClient for this job to ensure that the commit is finished before the job is executed.
