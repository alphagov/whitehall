class PublicAttachmentsController < ApplicationController
  include UploadsControllerHelper

  def show
    full_path = "clean-uploads/government/uploads/system/uploads/attachment_data/file/#{params[:id]}/#{params[:file]}.#{params[:extension]}"
