  ...
  def show
    respond_to do |format|
      format.html do
        ...
        unless !attachment_data.replaced? && (!attachment_data.draft? || (attachment_data.draft? && attachment_data.accessible_to?(current_user))) && attachment_data.visible_edition_for(current_user)
