class Admin::CallForEvidenceResponsesController < Admin::BaseController
  before_action :find_call_for_evidence
...
private
  ...
  def find_call_for_evidence
    @edition = CallForEvidence.find(params[:call_for_evidence_id])
  end
