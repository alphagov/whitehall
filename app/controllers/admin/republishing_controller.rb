class Admin::RepublishingController < Admin::BaseController
  ...
  def republish_page
    ...
    @republishing_event = build_republishing_event(action, page_to_republish[:presenter].constantize.new.content_id)
  ...
  def republish_organisation
    ...
    @republishing_event = build_republishing_event(action, @organisation.content_id)
  ...
  def republish_person
    ...
    @republishing_event = build_republishing_event(action, @person.content_id)
  ...
  def republish_role
    ...
    @republishing_event = build_republishing_event(action, @role.content_id)
  ...
  def republish_document
    ...
    @republishing_event = build_republishing_event(action, @document.content_id)
...
private
  ...
  def build_republishing_event(action, content_id)
    RepublishingEvent.new(user: current_user, reason: params.fetch(:reason), bulk: false, action:, content_id:)
  end
end
