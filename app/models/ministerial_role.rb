class MinisterialRole < Role
  ...
  has_many :news_articles, -> { where(type: "StandardEdition").where(configurable_document_type: %w[news_story press_release government_response world_news_story]).distinct }, through: :role_appointments, source: :editions
