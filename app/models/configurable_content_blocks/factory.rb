    ...
    def blocks
      {
        ...
        "integer" => {
          ...
          "lead_image_select" => ->(page) { ConfigurableContentBlocks::LeadImageSelect.new(page.non_svg_images, default_lead_image: page.default_lead_image, placeholder_image_url: page.placeholder_image_url) },
        },
        "object" => {
