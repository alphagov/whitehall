    ...
    def blocks
      {
        ...
        "integer" => {
          "image_card" => ->(page) { ConfigurableContentBlocks::ImageCard.new(page.valid_images.where(imagekind: :header_image).id) },#  .first_or_initialize(caption: page.default_lead_image_caption)) },
