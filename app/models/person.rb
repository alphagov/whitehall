class Person < ApplicationRecord
  ...
  has_many :news_articles, -> { where(type: "StandardEdition").where(configurable_document_type: %w[news_story press_release government_response world_news_story]) }, through: :role_appointments, source: :editions
