class Person < ApplicationRecord
  ...
  has_many :news_articles, -> { where("editions.type" => "StandardEdition").where("editions.configurable_document_type": ConfigurableDocumentType.where_group("news_article").map(&:key)) }, through: :role_appointments, source: :editions
