...
class AnnouncementPresenter
  ...
  def featured_news
    @featured_news ||= NewsArticle.published.featured.by_first_published_at.limit(3).includes(:document, :edition_relations, :policy_topics)
  end
  ...
  def candidate_news
    NewsArticle.published.not_featured.by_first_published_at.includes(:document, :edition_relations, :policy_topics)
  end
