module FeedHelper
  ...
  def documents_as_feed_entries(documents, builder, feed_updated_timestamp = Time.current)
    ...
    documents.each do |document|
      builder.entry(document, id: document_id(document, builder), url: public_document_url(document), published: document.first_public_at, updated: document.public_timestamp) do
