module Admin::EditionActionsHelper
  ...
  def legacy_types_options_container(user)
    legacy_classes = Whitehall.edition_classes - [StandardEdition]
  ...
  def combined_list_of_document_types(user)
    (legacy_types_options_container(user) + configurable_document_type_options)
      .uniq
