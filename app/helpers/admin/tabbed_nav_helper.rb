module Admin::TabbedNavHelper
  ...
  def standard_edition_nav_items(edition, current_path, current_tab)
    ...
    return config_driven_nav_items(edition, current_path, current_tab) if edition.is_a?(StandardEdition) && edition.defines_tabs?
  ...
  def config_driven_nav_items(edition, current_path, current_tab)
    ...
    edition.tabs.map do |tab|
...

      {
        ...
        current: on_dynamic_tab && current_tab == form_key,
      }
    end
  end
