    ...
    if statistics_announcement.cancelled?
      [
        tag.p("Announcement cancelled", class: "govuk-!-font-weight-bold govuk-!-margin-0 ") +
          tag.span(absolute_time(statistics_announcement.cancelled_at, class: "govuk-body-s app-view-history-entry__list-item-datetime") +
                     tag.span(" by ", class: " govuk-body-s app-view-history-entry__list-item-datetime") +
      ...
      statistics_announcement.statistics_announcement_dates.reverse.map do |previous_date|
        tag.p("Release date set to #{previous_date.display_date}", class: "govuk-!-font-weight-bold govuk-!-margin-0 ") +
          tag.span(absolute_time(previous_date.created_at), class: "govuk-body-s app-view-history-entry__list-item-datetime") +
          tag.span(" by ", class: " govuk-body-s app-view-history-entry__list-item-datetime") +
