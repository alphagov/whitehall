...
class AttachmentUploader < WhitehallUploader
  ...
  EXTENSION_WHITE_LIST = %w(chm csv diff doc docx dot dxf gif gml ics jpg kml ods odp odt pdf png eps ps ppt pptx rdf rtf sch txt wsdl xls xlsx xlt xlsm xml xsd xslt zip)
