...
| history_mode     | Y                                                                                                   | Whether the document can be marked as political. It can take several options: `enabled`, `can_be_marked_political_by_publishers`, `can_be_marked_political_by_system_based_on_organisation`, `can_be_marked_political_by_system_based_on_minister`, `always_marked_political_by_system` |
