...
- Via the [election rake tasks](../lib/tasks/election.rake) (`mark_political_content_for` and `unmark_political_content_for`) which applies the identifier logic to already published editions and their drafts. These require a republish to represent the content downstream.
