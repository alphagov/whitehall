...
Scenario: Publishing a policy that has a PDF attachment
  Given a published publication "Policy" with a PDF attachment
  When I visit the publication "Policy"
  Then I should see a link to the PDF attachment

Scenario: Viewing a policy that appears in multiple topics
  Given a published publication "Policy" that appears in the "Education" and "Work and pensions" topics
  When I visit the publication "Policy"
...
Scenario: Viewing a policy that has supporting documents
  Given a published publication "Outlaw Moustaches" with supporting documents "Waxing Dangers" and "Hair Lip"
...
Scenario: Viewing a policy that has multiple responsible ministers
  Given a published publication "Policy" that's the responsibility of:
