...
Scenario: A writer viewing a rejected policy
  Given an editor named "George" has rejected the policy titled "The policy" because "It needs a beginning, middle and end"
  And I am a writer
  When I view the policy titled "The policy"
  Then I should see that it was rejected by "George" because "It needs a beginning, middle and end"
