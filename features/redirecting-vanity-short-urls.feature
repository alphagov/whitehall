...
Scenario: Redirecting /bis
  Given the organisation "Department for Business, Innovation & Skills" exists
  When I visit "/bis"
  Then I should see the "Department for Business, Innovation & Skills" organisation's home page
