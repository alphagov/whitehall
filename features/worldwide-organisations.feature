Feature: Worldwide organisations
  Background:
    Given I am a writer
  ...
  Scenario: Creating a new draft worldwide organisation
    ...
    Then I should see the worldwide organisation "Test Worldwide Organisation" in the list of draft documents

  Scenario: Unpublishing a published worldwide organisation
    Given I am a managing editor
    Given a published worldwide organisation "Test Worldwide Organisation"
  ...
  Scenario: Removing a translation to an existing worldwide organisation
    Given an worldwide organisation in draft with a translation in French
  ...
  Scenario: Managing office information
    ...
    When I add an worldwide organisation "Test office" office for the home page with address, phone number, and some services
    Then I should be able to remove all services from the worldwide organisation "Test office" office
  ...
  Scenario: Editing an existing worldwide organisation page
    Given an worldwide organisation "Test Worldwide Organisation" with a "Personal information charter" page
    When I visit the pages tab for the worldwide organisation
    Then I should see the "Personal information charter" page on the list of pages with the details:
      | Summary | Some summary |
      | Body | Some body |
  ...
  Scenario: Adding a translation to an existing worldwide organisation page
    Given an worldwide organisation "Test Worldwide Organisation" with a "Personal information charter" page and a translation in French
  ...
  Scenario: Viewing audit history for the worldwide organisation and associated pages
    Given a published worldwide organisation "Test Worldwide Organisation" with a "Personal information charter" page
  ...
  Scenario: Reordering home page offices for a worldwide organisation
    Given An worldwide organisation "Test Worldwide Organisation" with home page offices "Home page office 1" and "Home page office 2"
