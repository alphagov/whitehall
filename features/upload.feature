...
Feature: Uploading attachments to editions
  ...
  Scenario: Keep existing attachments without new file name
    ...
    And I save the files
    Then I should see an error of "Attachment data new filename cannot be blank" on the upload page
  ...
  Scenario: Keep existing attachments with same file name
    ...
    And I save the files
    Then I should see an error of "File with name "greenpaper.pdf" already attached to document" on the upload page
  ...
  Scenario: Handle validation errors for new files when user has chosen to keep the existing file
    ...
    Then I should see an error of "Title cannot be blank" on the upload page
