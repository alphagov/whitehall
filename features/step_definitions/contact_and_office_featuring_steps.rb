Given(/^there is a worldwide organisation with some offices on its home page$/) do
  @the_organisation = create(:editionable_worldwide_organisation)
  @the_main_office = create(:worldwide_office, edition: @the_organisation, title: "HQ1.0")
  office1 = create(:worldwide_office, edition: @the_organisation, title: "The main office")
  office2 = create(:worldwide_office, edition: @the_organisation, title: "Summer office by the lake")
  office3 = create(:worldwide_office, edition: @the_organisation, title: "Emergency bunker office")
