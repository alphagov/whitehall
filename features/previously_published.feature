Feature: Previously published options
  ...
  Scenario: Creating a new publication without selecting a 'previously published' option
    Given I am a writer in the organisation "Department of Examples"
    When I start a new publication
    And I click save
    Then I do not see a validation error for the 'previously published' option

  Scenario: Creating a new publication and selecting a previously published date in the future
  ...
  Scenario: Creating a new publication and selecting previously published with no publication date
    Given the date is 2018-06-07
    And I am a writer in the organisation "Department of Examples"
    When I start a new publication
  ...
  Scenario: Creating a new publication with a valid previously published date
    Given the date is 2018-06-07
    And I am a writer in the organisation "Department of Examples"
    When I start a new publication
