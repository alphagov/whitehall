...
;(function (Modules) {
  ...
  class FormHelper {
    ...
    constructor(inputs, options = FormHelper.formDefaultOptions) {
    ...
    querySelector = (query) => this.form.querySelector(query)

    querySelectorAll = (query) => this.form.querySelectorAll(query)
