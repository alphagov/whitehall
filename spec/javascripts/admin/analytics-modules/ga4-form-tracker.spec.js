describe('GOVUK.analyticsGa4.analyticsModules.Ga4FormTracker', function () {
  let container, trackedInputs, mockGa4SendData, form

  const type = 'document-type'

  const FormHelper = window.GOVUK.Modules.JasmineHelpers.FormHelper

  const expectedAttributes = {
    event_name: 'select_content',
    type,
    section: FormHelper.formDefaultOptions.label,
    text: FormHelper.formDefaultOptions.value
  }
  ...
  beforeAll(() => {
    ...
    container.dataset.ga4DocumentType = type
