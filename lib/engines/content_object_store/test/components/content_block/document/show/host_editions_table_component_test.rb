...
class ContentObjectStore::ContentBlock::Document::Show::HostEditionsTableComponentTest < ViewComponent::TestCase
  extend Minitest::Spec::DSL
  include Rails.application.routes.url_helpers

  let(:described_class) { ContentObjectStore::ContentBlock::Document::Show::HostEditionsTableComponent }
