class ContentObjectStore::ContentBlockEditionsController < Admin::BaseController
  ...
  def create
    @schema = ContentObjectStore::SchemaService.schema_for_block_type(params[:content_object_store_content_block_edition][:block_type])
...
private
  ...
  def edition_params
    params.require(:content_object_store_content_block_edition).permit(:document_title, :block_type, details: @schema.fields)
  end
end
