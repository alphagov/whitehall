...
class ContentBlockManager::ContentBlockEdition::New::SelectSchemaComponentTest < ViewComponent::TestCase
  ...
  let(:component) do
    ContentBlockManager::ContentBlockEdition::New::SelectSchemaComponent.new(
      heading:,
      heading_caption:,
      error_message:,
      schemas:,
