...
class ContentBlockManager::ContentBlockEdition::New::ErrorSummaryComponentTest < ViewComponent::TestCase
  extend Minitest::Spec::DSL

  let(:component) do
    ContentBlockManager::ContentBlockEdition::New::ErrorSummaryComponent.new(error_message:)
  end
