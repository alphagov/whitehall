...
class ContentBlockManager::ContentBlockEdition::Details::FormComponentTest < ViewComponent::TestCase
  ...
  let(:baz_field) { stub("field", name: "baz", component_name: "enum", enum_values: %w[some enum], default_value: nil, component_class: ContentBlockManager::ContentBlockEdition::Details::Fields::EnumComponent) }
