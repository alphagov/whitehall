...
class ContentBlockManager::ContentBlockEdition::Details::Fields::GovspeakEnabledTextareaComponentTest < ViewComponent::TestCase
  ...
  describe "GovspeakEnabledTextareaComponent" do
    ...
    describe "'Markdown supported' indicator" do
      context "when the field IS declared 'govspeak-enabled' in the subschema" do
        ...
        it "displays a 'Markdown supported' hint" do
          render_inline component

          assert_selector(COMPONENT_CLASS) do |component|
            displays_indication_that_markdown_is_supported(component)
          end
        end
      ...
      context "when the field is NOT declared 'govspeak-enabled in the subschema" do
        ...
        it "does NOT display the 'Markdown supported' hint" do
          render_inline component

          assert_selector(COMPONENT_CLASS) do |component|
            displays_no_indication_that_markdown_is_supported(component)
          end
        end
      end
    end
  ...
  def displays_indication_that_markdown_is_supported(component)
    component.assert_selector(
      ".govuk-hint",
  ...
  def displays_no_indication_that_markdown_is_supported(component)
