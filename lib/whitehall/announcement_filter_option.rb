module Whitehall
  class AnnouncementFilterOption < FilterOption
    ...
    PressRelease = create(id: 1, label: "Press releases", search_format_types: [NewsArticleType::PressRelease.search_format_types].flatten, edition_types: ["NewsArticle"], news_article_types: [NewsArticleType::PressRelease])
