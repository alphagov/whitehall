module Whitehall
  class PublicationFilterOption < FilterOption
    ...
    Consultation        = create(id: 1, slug: "consultations", label: "All consultations", search_format_types: ['publicationesque-consultation'], publication_types: [], edition_types: %w[Consultation], group_key: 'Consultations')
    OpenConsultation    = create(id: 2, label: "Open consultations", search_format_types: ['consultation-open'], publication_types: [], edition_types: %w[Consultation], group_key: 'Consultations')
    ClosedConsultation  = create(id: 3, label: "Closed consultations", search_format_types: ['consultation-closed', 'consultation-outcome'], publication_types: [], edition_types: %w[Consultation], group_key: 'Consultations')
    ...
    Statistics          = create(id: 11, label: "Statistics", search_format_types: ['publicationesque-statistics'], publication_types: [PublicationType::OfficialStatistics, PublicationType::NationalStatistics], edition_types: %w[StatisticalDataSet], group_key: 'Research and statistics')
