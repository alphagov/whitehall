module Whitehall
  class PublicationFilterOption < FilterOption
    ...
    ClosedConsultation  = create(id: 3, label: "Closed consultations", search_format_types: %w(consultation-closed consultation-outcome), publication_types: [], edition_types: ['Consultation'], group_key: 'Consultations')
    ...
    Guidance            = create(id: 6, label: "Guidance", search_format_types: %w(publication-guidance publication-statutory-guidance), publication_types: [PublicationType::Guidance, PublicationType::StatutoryGuidance], group_key: 'Policy and guidance')
