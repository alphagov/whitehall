module Whitehall
  class PublicationFilterOption < FilterOption
    ...
    Statistics          = create(id: 11, label: "Statistics", search_format_types: ['publicationesque-statistics'], publication_types: [PublicationType::OfficialStatistics, PublicationType::NationalStatistics], edition_types: ["StatisticalDataSet"], group_key: 'Research and statistics')
