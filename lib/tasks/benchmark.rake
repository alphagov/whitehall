...
namespace :benchmark do
  desc "Benchmark test long document"
  task long_document: :environment do
    ...
    Benchmark.bmbm do |x|
      ...
      x.report("corp info page document once:") { Govspeak::Document.new(corp_info_markdown).structured_headers }
      x.report("long document once:") { Govspeak::Document.new(long_markdown).structured_headers }
      x.report("long document 100 times:") { 100.times { ; Govspeak::Document.new(long_markdown).structured_headers; } }
      x.report("long document 400 times:") { 400.times { ; Govspeak::Document.new(long_markdown).structured_headers; } }
    end
  end
end
