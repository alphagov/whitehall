...
class Admin::Editions::HistoryModeFormControlsTest < ViewComponent::TestCase
  test "conditionally displays the government selector for gds editor users" do
    ...
    published_edition = create(:published_publication, government_id: previous_government.id)
    new_draft = create(:publication, document: published_edition.document, government_id: previous_government.id)
