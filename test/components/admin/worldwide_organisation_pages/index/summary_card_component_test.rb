...
class Admin::WorldwideOrganisationPages::Index::SummaryCardComponentTest < ViewComponent::TestCase
  ...
  test "renders a worldwide organisation page summary card" do
    ...
    assert_selector ".govuk-summary-card__actions .govuk-summary-card__action:nth-child(1) a[href='#{edit_admin_worldwide_organisation_page_path(page.edition, page)}']"
    assert_selector ".govuk-summary-card__actions .govuk-summary-card__action:nth-child(2) a[href='#{confirm_destroy_admin_worldwide_organisation_page_path(page.edition, page)}']"
  ...
  test "renders the add translation action when there are missing translations for a page" do
    ...
    assert_selector ".govuk-summary-card__actions .govuk-summary-card__action:nth-child(2) a[href='#{admin_worldwide_organisation_page_translations_path(worldwide_organisation, page, page.translation_locale)}']", text: "Add translation"
  end
