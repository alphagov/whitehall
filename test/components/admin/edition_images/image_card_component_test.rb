...
class Admin::EditionImages::ImageCardComponentTest < ViewComponent::TestCase
  ...
  context "usage: lead" do
    test "renders details guidance when image usage case is 'lead" do
      ...
      render_inline(Admin::EditionImages::ImageCardComponent.new(edition:, image: nil, image_usage: lead_usage))
    ...
    test "renders the thumbnail for a 'lead' usage image" do
      ...
      render_inline(Admin::EditionImages::ImageCardComponent.new(edition:, image:, image_usage: lead_usage))
    ...
    test "renders the 'PROCESSING' tag image when lead image is selected but has missing assets" do
      ...
      render_inline(Admin::EditionImages::ImageCardComponent.new(edition:, image: lead_image, image_usage: lead_usage))
