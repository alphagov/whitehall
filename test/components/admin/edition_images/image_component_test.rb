...
class Admin::EditionImages::ImageComponentTest < ViewComponent::TestCase
  ...
  test "image filename markdown displayed for embeddable usages" do
    ...
    render_inline(Admin::EditionImages::ImageComponent.new(edition:, image: images.first, image_usage: ImageUsage.new(embeddable: true)))
  ...
  test "image index markdown handles a lead image being present correctly" do
    ...
    render_inline(Admin::EditionImages::ImageComponent.new(edition:, image: images.third, image_usage: ImageUsage.new(embeddable: true)))
