...
class Admin::WorldwideOffices::Index::OfficeSummaryCardComponentTest < ViewComponent::TestCase
  ...
  test "renders the correct default values when the office is a main office" do
    ...
    worldwide_office = build_stubbed(:worldwide_office, legacy_worldwide_organisation: @worldwide_organisation, contact:)
  ...
  test "renders the services row when the office has a service" do
    ...
    worldwide_office = build_stubbed(:worldwide_office, legacy_worldwide_organisation: @worldwide_organisation, contact:, services: [worldwide_service])
  ...
  test "renders access and opening times when the office has access and opening time information" do
    contact = build_stubbed(:contact)
    worldwide_office = build_stubbed(:worldwide_office, legacy_worldwide_organisation: @worldwide_organisation, contact:, access_and_opening_times: "Always open")
