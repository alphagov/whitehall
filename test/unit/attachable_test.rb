...
class AttachableForceReviewTest < ActiveSupport::TestCase
  class TestObject
  ...
  test 'it adds an attachments_were_bulk_uploaded attribute' do
    assert TestObject.new.respond_to?(:attachments_were_bulk_uploaded)
  end

  test 'it is valid if the attachments_were_bulk_uploaded attribute is nil' do
    t = TestObject.new
    assert t.valid?
  end

  test 'it is invalid if the attachments_were_bulk_uploaded attribute is not nil' do
    t = TestObject.new
