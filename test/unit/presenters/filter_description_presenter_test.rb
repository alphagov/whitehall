...
class FilterDescriptionPresenterTest < ActionView::TestCase
  ...
  def rendered_description(filter, opts = {})
    Nokogiri::HTML::DocumentFragment.parse(FilterDescriptionPresenter.new(filter, base_url, opts).render)
  end
