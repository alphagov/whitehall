...
require './app/presenters/document_series_group_presenter'
require 'ostruct'

class DocumentSeriesGroupPresenterTest < ActiveSupport::TestCase
  ...
  setup do
    ...
    @subject = DocumentSeriesGroupPresenter.new(group, :the_view_context, edition_collection_presented_by: DummyEditionCollectionPresenter)
  end
