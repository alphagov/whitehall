...
require './app/presenters/document_series_presenter'
require 'ostruct'

class DocumentSeriesPresenterTest < ActiveSupport::TestCase
  class DummyGroupPresenter
  end

  setup do
    @groups = [:group_1, :group_2, :group_3]
    document_series = OpenStruct.new(
      title:   :the_title,
      summary: :the_summary,
      body:    :the_body,
      groups: @groups
    )
    @subject = DocumentSeriesPresenter.new(document_series, :the_view_context, groups_presented_by: DummyGroupPresenter)
  end
