...
class OrganisationTest < ActiveSupport::TestCase
  ...
  test "topical_events are explicitly ordered" do
    ...
    organisation = create(:organisation)
    organisation.organisation_classifications.create!(topical_event_id: topical_events[0].id, ordering: 2)
    organisation.organisation_classifications.create!(topical_event_id: topical_events[1].id, ordering: 1)
