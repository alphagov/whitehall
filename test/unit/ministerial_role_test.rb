...
class MinisterialRoleTest < ActiveSupport::TestCase
  ...
  test "should return the person, ministerial role and all organisation names" do
    ministerial_role = build(:ministerial_role, name: "Treasury secretary", people: [build(:person, name: "Frank")],
                        organisations: [
  ...
  test "should return the ministerial role and organisation names when person is missing" do
    ministerial_role = build(:ministerial_role, name: "Treasury secretary", people: [],
                        organisations: [build(:organisation, name: "Department of Health")])
  ...
  test "should return the ministerial role name when person and organisations are missing" do
    ministerial_role = build(:ministerial_role, name: "Treasury secretary", people: [], organisations: [])
    assert_equal "Treasury secretary", ministerial_role.to_s
  end

  test "should return the person's name" do
    ministerial_role = build(:ministerial_role, people: [build(:person, name: "Bob")])
    assert_equal "Bob", ministerial_role.person_name
  end

  test "should indicate that the role is vacant" do
    ministerial_role = build(:ministerial_role, people: [])
  ...
  test "can return the set of ministers in alphabetical order" do
    charlie = create(:ministerial_role, people: [build(:person, name: "Charlie Parker")])
    alphonse = create(:ministerial_role, people: [build(:person, name: "Alphonse Ziller")])
    boris = create(:ministerial_role, people: [build(:person, name: "Boris Swingler")])
