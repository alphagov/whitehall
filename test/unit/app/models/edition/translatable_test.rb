...
class Edition::TranslatableTest < ActiveSupport::TestCase
  ...
  test "locale_can_be_changed? returns false for a persisted StandardEdition news story" do
    assert_not create(:news_story, :with_organisations).locale_can_be_changed?
  end
