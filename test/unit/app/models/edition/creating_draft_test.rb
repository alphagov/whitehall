...
class Edition::WorkflowTest < ActiveSupport::TestCase
  ...
  test "should build a draft copy of the unpublished edition with the supplied creator" do
    unpublished_edition = create(:unpublished_edition)
    new_creator = create(:writer)
    draft_edition = unpublished_edition.create_draft(new_creator)

    assert_not draft_edition.published?
    assert_not draft_edition.submitted?
    assert_equal new_creator, draft_edition.creator
    assert_equal unpublished_edition.title, draft_edition.title
    assert_equal unpublished_edition.body, draft_edition.body
  end
