...
class Edition::SluggingTest < ActiveSupport::TestCase
  ...
  describe "unmodifiable edition slug behaviour" do
    ...
    test "it sets an override on new drafts from published, where a custom slug is set, but not saved as an override" do
      published_edition = SluggableEdition.create_published!(title: "Original Title")
      published_edition.slug = "original-title-override"
      published_edition.slug_from_title = "original-title-override"
      published_edition.save!(validate: false)
      assert_equal "original-title-override", published_edition.slug
      assert_equal "original-title-override", published_edition.slug_from_title
      assert_nil published_edition.slug_override

      draft_edition = published_edition.create_draft(create(:writer))

      assert_equal "original-title-override", published_edition.slug
      assert_equal "original-title", draft_edition.slug_from_title
