...
class Admin::EditionFilterTestWithForms < ActiveSupport::TestCase
  setup do
    @current_user = build(:gds_editor)
  end
  ...
  test "should filter by news article category" do
    news_story_document_type = build_configurable_document_type_with_forms("news_story", { "settings" => { "configurable_document_group" => "news_article" } })
    press_release_document_type = build_configurable_document_type_with_forms("press_release", { "settings" => { "configurable_document_group" => "news_article" } })
    subtypes = news_story_document_type.deep_merge(press_release_document_type)
    ConfigurableDocumentType.setup_test_types(subtypes)
  ...
  test "should match both 'StandardEdition' type and sub-type (of 'concrete' model) of the same name" do
    configurable_document_type = build_configurable_document_type_with_forms("press_release")
    ConfigurableDocumentType.setup_test_types(configurable_document_type)
