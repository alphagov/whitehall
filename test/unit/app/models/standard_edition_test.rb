...
class StandardEditionTest < ActiveSupport::TestCase
  ...
  test "it allows inline attachments if the configurable document type settings permit them" do
    test_type_with_inline_attachments =
      build_configurable_document_type(
        "test_type_with_inline_attachments", {
          "settings" => {
    ...
    test_type_without_inline_attachments =
      build_configurable_document_type(
        "test_type_without_inline_attachments", {
          "settings" => {
            "inline_attachments_enabled" => false,
          },
        }
      )

    ConfigurableDocumentType.setup_test_types(test_type_with_inline_attachments.merge(test_type_without_inline_attachments))
    page_with_inline_attachments = StandardEdition.new(configurable_document_type: "test_type_with_inline_attachments")
    page_without_inline_attachments = StandardEdition.new(configurable_document_type: "test_type_without_inline_attachments")
    assert page_with_inline_attachments.allows_inline_attachments?
    assert_not page_without_inline_attachments.allows_inline_attachments?
  end
