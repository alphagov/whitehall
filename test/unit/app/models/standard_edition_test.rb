...
class StandardEditionTest < ActiveSupport::TestCase
  ...
  test "requires worldwide organisation association if specified in the configurable document type settings" do
    test_type =
      build_configurable_document_type(
        "test_type", {
          "associations" => [
    ...
    assert_not page.respond_to?(:organisation_association_required?)
  end
end
