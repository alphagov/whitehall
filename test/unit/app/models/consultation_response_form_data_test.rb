...
class ConsultationResponseFormDataTest < ActiveSupport::TestCase
  ...
  test "#asset_uploaded? should return true when there is an original asset" do
    ...
    assert consultation_response_form_data.asset_uploaded?
  end
  ...
  test "#asset_uploaded? should return false when there is no asset" do
    ...
    assert_equal false, consultation_response_form_data.asset_uploaded?
  end
  ...
  test "#asset_uploaded? returns false on update if the new asset has not finished uploading" do
    ...
    assert_not consultation_response_form_data.asset_uploaded?
  end
end
