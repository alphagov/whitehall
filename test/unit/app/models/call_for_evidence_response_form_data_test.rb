...
class CallForEvidenceResponseFormDataTest < ActiveSupport::TestCase
  ...
  test "#attachments returns the response form when present" do
    ...
    assert_equal [call_for_evidence_response_form], call_for_evidence_response_form_data.attachments
  end

  test "#attachments returns a null attachment when there is no response form" do
    call_for_evidence_response_form_data = build(:call_for_evidence_response_form_data)

    assert_instance_of Attachment::Null, call_for_evidence_response_form_data.attachments.first
  end
end
