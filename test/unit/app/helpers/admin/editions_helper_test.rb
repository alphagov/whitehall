...
class Admin::EditionsHelperTest < ActionView::TestCase
  ...
  test "warn_about_lack_of_contacts_in_body?" do
    assert_not warn_about_lack_of_contacts_in_body?(Publication.new)
    assert_not warn_about_lack_of_contacts_in_body?(Speech.new)
  end
