...
class SocialMediaLinksValidatorTest < ActiveSupport::TestCase
  ...
  test "social media links does not error when blank" do
    block_content = SocialMediaLinksValidatorTestClass.new
  ...
  test "social media links are invalid when no social media service is chosen and a URL is provided" do
    ...
    assert_equal ["Social media links - account 1 must have a service selected."], block_content.errors.full_messages
  end
  ...
  test "social media links are invalid when a social media service is chosen but no URL is provided" do
    ...
    assert_equal ["Social media links - the \"Facebook\" account must have a URL."], block_content.errors.full_messages
  end
  ...
  test "social media links are invalid when a social media service is chosen and a malformed URL is provided" do
    ...
    assert_equal ["Social media links - the \"Facebook\" account has an invalid URL. Use the full URL, including https://"], block_content.errors.full_messages
  end
  ...
  test "social media links are invalid if two of the same social media service are provided" do
    ...
    assert_equal ["Social media links - you cannot add more than one \"Facebook\" account."], block_content.errors.full_messages
  end
  ...
  test "social media links are invalid if two services have the same URL" do
    ...
    assert_equal ["Social media links - you cannot add more than one account with the URL \"http://facebook.com/govuk\"."], block_content.errors.full_messages
  end
