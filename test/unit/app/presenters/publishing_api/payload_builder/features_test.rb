          ...
          ordered_featured_documents: [
            {
              ...
              image: { url: "#{Plek.asset_root}/media/asset_manager_id_original/minister-of-funk.960x640.jpg",
                       ...
                       alt_text: "" },
              summary: featured_edition_1.summary, # We don't send govspeak html for standard edition feature summaries
            ...
            },
            {
              ...
              image: { url: "#{Plek.asset_root}/media/asset_manager_id_original/minister-of-funk.960x640.jpg",
                       ...
                       high_resolution_url: "#{Plek.asset_root}/media/asset_manager_id_s712/s712_minister-of-funk.960x640.jpg",
                       alt_text: "" },
              summary: featured_edition_2.summary,
            ...
            },
            {
              ...
              image: { url: "#{Plek.asset_root}/media/asset_manager_id_original/minister-of-funk.960x640.jpg",
                       ...
                       high_resolution_url: "#{Plek.asset_root}/media/asset_manager_id_s712/s712_minister-of-funk.960x640.jpg",
                       alt_text: "" },
              summary: featured_edition_3.summary,
