...
class Whitehall::DocumentFilter::DescriptionTest < ActiveSupport::TestCase
    ...
    test 'builds a human-readable description of a document filter using the filter drop-down texts' do
      publication_feed = "https://example.com/government/publications.atom?&departments%5B%5D=all&keywords=&official_document_status=all&publication_filter_option=closed-consultations&topics%5B%5D=borders-and-immigration"
