...
module Whitehall::DocumentFilter
  class MysqlTest < ActiveSupport::TestCase
    ...
    test "date param sets date attribute" do
      assert_equal Date.parse("2012-01-01 12:23:45"), Whitehall::DocumentFilter::Mysql.new(from_date: "2012-01-01 12:23:45").from_date
      assert_equal Date.parse("2012-01-01 12:23:45"), Whitehall::DocumentFilter::Mysql.new(to_date: "2012-01-01 12:23:45").to_date
    end
