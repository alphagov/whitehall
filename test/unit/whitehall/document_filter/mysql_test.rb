...
module Whitehall::DocumentFilter
  class MysqlTest < ActiveSupport::TestCase
    ...
    test "#all_topics_with :announcement returns all topics with announcements, alphabetically" do
      ...
      Whitehall::DocumentFilter::Mysql.new([]).all_topics_with(:announcement)
    end
    ...
    test "#all_topics_with :publication returns all topics with publications, alphabetically" do
      ...
      assert_equal [aardvark, zebra], Whitehall::DocumentFilter::Mysql.new([]).all_topics_with(:publication)
    end
    ...
    test "#all_organisations returns all organisations with content, alphabetically" do
      ...
      Whitehall::DocumentFilter::Mysql.new([]).all_organisations_with(:document_type)
    end

    test "#publication_types_for_filter returns all publication filter option types" do
      assert_equal Whitehall::PublicationFilterOption.all, Whitehall::DocumentFilter::Mysql.new([]).publication_types_for_filter
    end
    ...
    test "#announcement_types_for_filter returns all announcement filter option types" do
      ...
      assert_equal announcement_type_options, Whitehall::DocumentFilter::Mysql.new([]).announcement_types_for_filter.map(&:label)
    end
