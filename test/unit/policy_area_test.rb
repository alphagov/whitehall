...
class PolicyAreaTest < ActiveSupport::TestCase
  ...
  test "should allow setting ordering of policies" do
    ...
    first_association = policy_area.policy_area_memberships.find_by_policy_id(first_policy.id)
    second_association = policy_area.policy_area_memberships.find_by_policy_id(second_policy.id)
