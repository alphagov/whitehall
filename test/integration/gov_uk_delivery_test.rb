...
class GovUkDeliveryTest < ActiveSupport::TestCase
  ...
  test "Publishing a policy calls govuk-delivery API" do
    ...
    Whitehall::GovUkDelivery::GovUkDeliveryEndPoint.any_instance.stubs(:govuk_delivery_tags).returns(['http://example.com/feed'])
    Whitehall::GovUkDelivery::GovUkDeliveryEndPoint.any_instance.stubs(:govuk_delivery_email_body).returns('body')
