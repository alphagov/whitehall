...
class Admin::RepublishingControllerTest < ActionController::TestCase
  ...
  view_test "GDS Admin users should be able to GET :index and see links to republishable content" do
    ...
    assert_select ".govuk-table:nth-of-type(3) .govuk-table__body .govuk-table__row:nth-child(6) .govuk-table__cell:nth-child(2) a[href='/government/admin/republishing/bulk/all-individual-pages/confirm']", text: "Republish all individual pages"
    assert_select ".govuk-table:nth-of-type(3) .govuk-table__body .govuk-table__row:nth-child(7) .govuk-table__cell:nth-child(2) a[href='/government/admin/republishing/bulk/all-non-editionable-content/confirm']", text: "Republish all non-editionable content"
    assert_select ".govuk-table:nth-of-type(3) .govuk-table__body .govuk-table__row:nth-child(8) .govuk-table__cell:nth-child(2) a[href='/government/admin/republishing/bulk/all-published-organisation-about-us-pages/confirm']", text: "Republish all published organisation 'About us' pages"
    assert_select ".govuk-table:nth-of-type(3) .govuk-table__body .govuk-table__row:nth-child(9) .govuk-table__cell:nth-child(2) a[href='/government/admin/republishing/bulk/by-type/new']", text: "Republish all by type"
    assert_select ".govuk-table:nth-of-type(3) .govuk-table__body .govuk-table__row:nth-child(10) .govuk-table__cell:nth-child(2) a[href='/government/admin/republishing/bulk/documents-by-organisation/new']", text: "Republish all documents by organisation"
