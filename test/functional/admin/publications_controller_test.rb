...
class Admin::PublicationsControllerTest < ActionController::TestCase
  ...
  should_allow_association_with_topical_event_documents :publication
  ...
  access_limiting_organisations_should_allow_access_limiting_of :publication
  access_limiting_individuals_should_allow_access_limiting_of :publication
