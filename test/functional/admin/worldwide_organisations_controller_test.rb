...
class Admin::WorldwideOrganisationsControllerTest < ActionController::TestCase
  ...
  access_limiting_organisations_should_allow_access_limiting_of :worldwide_organisation
  access_limiting_individuals_should_allow_access_limiting_of :worldwide_organisation
