...
class Admin::CallsForEvidenceControllerTest < ActionController::TestCase
  ...
  should_allow_association_with_topical_event_documents :call_for_evidence
  ...
  access_limiting_organisations_should_allow_access_limiting_of :call_for_evidence
  access_limiting_individuals_should_allow_access_limiting_of :call_for_evidence
