...
class Admin::NewDocumentControllerTest < ActionController::TestCase
  ...
  view_test "GET #index renders the Topical Event option" do
    get :index

    assert_response :success
    assert_select "input[type=radio][name=new_document_options][value=topical_event]"
  end
  ...
  test "POST #new_document_options_redirect redirects topical_event selections to the standard editions path" do
    request_params = {
