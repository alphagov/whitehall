...
class Admin::StatisticalDataSetsControllerTest < ActionController::TestCase
  ...
  access_limiting_organisations_should_allow_access_limiting_of :statistical_data_set
  access_limiting_individuals_should_allow_access_limiting_of :statistical_data_set
