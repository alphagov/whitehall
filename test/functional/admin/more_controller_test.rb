...
class Admin::MoreControllerTest < ActionController::TestCase
  ...
  view_test "GET #index does not render Retag content option when the user is not a GDS Admin." do
    organisation = create(:organisation, name: "cabinet-minister")
    login_as(:writer, organisation)
    ...
    assert_select ".govuk-list"
    refute_select "a.govuk-link", text: "Retag content"
  end

  view_test "GET #index renders Retag content option when the user is a GDS Admin." do
    organisation = create(:organisation, name: "government-digital-service")
    login_as(:gds_admin, organisation)
    ...
    assert_select ".govuk-list"
    assert_select "a.govuk-link", text: "Retag content"
  end
end
