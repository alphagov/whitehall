...
class Admin::FatalityNoticesControllerTest < ActionController::TestCase
  ...
  access_limiting_organisations_should_allow_access_limiting_of :fatality_notice
  access_limiting_individuals_should_allow_access_limiting_of :fatality_notice
