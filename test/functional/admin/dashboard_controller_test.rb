...
class Admin::DashboardControllerTest < ActionController::TestCase
  ...
  context "Tests using forms schema for configurable content blocks" do
    setup do
      ...
      draft_test_type = build_configurable_document_type_with_forms("draft_test_type", { "title" => "Draft Test Type" })
      ConfigurableDocumentType.setup_test_types(build_configurable_document_type_with_forms("force_published_test_type", { "title" => "Force Published Test Type" }).merge(draft_test_type))
      @draft_standard_edition = create(
        :draft_standard_edition,
        authors: [@current_user],
        configurable_document_type: "draft_test_type",
