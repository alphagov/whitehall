...
class WorldLocationNewsControllerTest < ActionController::TestCase
  ...
  view_test "should display translated page labels when requested in a different locale" do
    ...
    assert_select ".gem-c-title__context", "Nouvelles des emplacements dans le monde"
    assert_select "#publications .govuk-body a", /Afficher toutes nos publications/
    assert_select ".govuk-body a", /Afficher toutes nos annonces/
  end
