...
class PublicationsControllerTest < ActionController::TestCase
  ...
  view_test "index displays date filter" do
    get :index, from_date: "2011-01-01", to_date: "2012-01-01"

    assert_select "input#from_date[name='from_date'][value=2011-01-01]"
    assert_select "input#to_date[name='to_date'][value=2011-01-01]"
  end
