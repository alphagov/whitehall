...
class CountriesControllerTest < ActionController::TestCase
  ...
  test "shows featured news articles in order of first publication date with most recent first" do
    ...
    create(:document_country, edition: less_recent_news_article, country: country, featured: true)
    create(:document_country, edition: more_recent_news_article, country: country, featured: true)
  ...
  test "shows a maximum of 3 featured news articles" do
    ...
    4.times do
      ...
      create(:document_country, edition: news_article, country: country, featured: true)
    end
