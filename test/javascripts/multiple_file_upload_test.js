module("Uploading multiple files", {
  setup: function() {
    ...
    this.first_input = $('<input id="document_edition_attachments_attributes_0_attachment_attributes_file" name="document[edition_attachments_attributes][0][attachment_attributes][file]" type="file" />');

    file_upload.append('<label for="document_edition_attachments_attributes_0_attachment_attributes_title">Title</label>');
    file_upload.append('<input id="document_edition_attachments_attributes_0_attachment_attributes_title" name="document[edition_attachments_attributes][0][attachment_attributes][title]" size="30" type="text" />');
    file_upload.append('<label for="document_edition_attachments_attributes_0_attachment_attributes_caption">Caption</label>');
    file_upload.append('<textarea id="document_edition_attachments_attributes_0_attachment_attributes_caption" name="document[edition_attachments_attributes][0][attachment_attributes][caption]"></textarea>');
    file_upload.append('<label for="document_edition_attachments_attributes_0_attachment_attributes_file">File</label>');
    file_upload.append(this.first_input);
    file_upload.append('<input id="document_edition_attachments_attributes_0_attachment_attributes_file_cache" name="document[edition_attachments_attributes][0][attachment_attributes][file_cache]" type="hidden" />');
...
test("should increment the referenced ID of the title label for each new set of inputs added", function() {
  ...
  equal(latest_input.attr('for'), "document_edition_attachments_attributes_1_attachment_attributes_title");

  fireChangeEventOnLastFileInputOf(this.fieldset);
  latest_input = this.fieldset.find("label:contains('Title'):last");
  equal(latest_input.attr('for'), "document_edition_attachments_attributes_2_attachment_attributes_title");
});
...
test("should increment the ID and name of the text input for each set of new inputs added", function() {
  ...
  equal(latest_input.id, "document_edition_attachments_attributes_1_attachment_attributes_title");
  ...
  equal(latest_input.id, "document_edition_attachments_attributes_2_attachment_attributes_title");
...
test("should increment the ID and name of the textareas for each set of new inputs added", function() {
  ...
  equal(latest_input.id, "document_edition_attachments_attributes_1_attachment_attributes_caption");
  ...
  equal(latest_input.id, "document_edition_attachments_attributes_2_attachment_attributes_caption");
...
test("should increment the referenced ID of the file label for each set of new inputs added", function() {
  ...
  equal(latest_input.attr('for'), "document_edition_attachments_attributes_1_attachment_attributes_file");

  fireChangeEventOnLastFileInputOf(this.fieldset);
  latest_input = this.fieldset.find("label:contains('File'):last");
  equal(latest_input.attr('for'), "document_edition_attachments_attributes_2_attachment_attributes_file");
});
...
test("should increment the ID and name of the file input for each set of new inputs added", function() {
  ...
  equal(latest_input.id, "document_edition_attachments_attributes_1_attachment_attributes_file");
  ...
  equal(latest_input.id, "document_edition_attachments_attributes_2_attachment_attributes_file");
...
test("should increment the ID and name of the hidden cache input for each set of new inputs added", function() {
  ...
  equal(latest_input.id, "document_edition_attachments_attributes_1_attachment_attributes_file_cache");
  ...
  equal(latest_input.id, "document_edition_attachments_attributes_2_attachment_attributes_file_cache");
    ...
    this.fieldset = $('\
      <fieldset class="multiple_file_uploads">\
        <div class="file_upload">\
          <label for="document_edition_attachments_attributes_0_attachment_attributes_title">Title</label>\
          <input id="document_edition_attachments_attributes_0_attachment_attributes_title"\ name="document[edition_attachments_attributes][0][attachment_attributes][title]" size="30" type="text" value="something" />\
          <div class="field_with_errors">\
            <label for="document_edition_attachments_attributes_0_attachment_attributes_file">File</label>\
          </div>\
          <div class="field_with_errors">\
            <input id="document_edition_attachments_attributes_0_attachment_attributes_file"\ name="document[edition_attachments_attributes][0][attachment_attributes][file]" type="file" />\
          </div>\
          <input id="document_edition_attachments_attributes_0_attachment_attributes_file_cache"\ name="document[edition_attachments_attributes][0][attachment_attributes][file_cache]" type="hidden" />\
        </div>\
      </fieldset>\
    ');
    $('#qunit-fixture').append(this.fieldset);
