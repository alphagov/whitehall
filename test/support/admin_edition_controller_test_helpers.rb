module AdminEditionControllerTestHelpers
  ...
  module ClassMethods
    ...
    def should_be_translatable(edition_type)
      view_test "show displays the number of translations excluding the default English translation" do
        edition = create("draft_#{edition_type}")
        with_locale(:es) { edition.update_attributes!(attributes_for("draft_#{edition_type}")) }
      ...
      view_test "show displays a link to edit an existing translation" do
        edition = create("draft_#{edition_type}", title: 'english-title', summary: 'english-summary', body: 'english-body')
      ...
      view_test "show displays the language of the translation on published editions" do
        edition = build("published_#{edition_type}", title: 'english-title', summary: 'english-summary', body: 'english-body')
        with_locale(:fr) do
      ...
      view_test "show displays all non-english translations" do
        edition = create("draft_#{edition_type}", title: 'english-title', summary: 'english-summary', body: 'english-body-in-govspeak')
