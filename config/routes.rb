...
Whitehall::Application.routes.draw do
  ...
  scope Whitehall.router_prefix, shallow_path: Whitehall.router_prefix do
    ...
    get "/publications/:publication_id/:id" => 'attachments#show_html', as: 'publication_html_version'
    ...
    match "/consultations/:consultation_id/:id" => 'attachments#show_html', as: 'consultation_html_version'
