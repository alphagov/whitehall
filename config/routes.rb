...
Whitehall::Application.routes.draw do
  ...
  get '/government/uploads/system/uploads/consultation_response_form/*path' => LongLifeRedirect.new('/government/uploads/system/uploads/consultation_response_form_data/'), format: true
