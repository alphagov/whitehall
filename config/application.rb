...
module Whitehall
  class Application < Rails::Application
    ...
    config.i18n.available_locales = [:en, :ar, :az, :be, :bg, :bn, :cs, :de, :el, :es, :fa, :fr, :he, :hi, :hu, :hy, :it, :ja, :ka, :ko, :lt, :lv, :ms, :pl, :ps, :pt, :ro, :ru, :si, :sk, :so, :sq, :sr, :sw, :ta, :th, :tk, :tr, :uk, :ur, :uz, :vi, :zh]
