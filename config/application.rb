...
module Whitehall
  class Application < Rails::Application
    ...
    config.i18n.available_locales = [:en, :ar, :az, :be, :bg, :bn, :cs, :cy, :de, :dr, :el, :es, :fa, :fr, :he, :hi, :hu, :hy, :id, :it, :ja, :ka, :ko, :lt, :lv, :ms, :pl, :ps, :pt, 'pt-br', :ro, :ru, :si, :sk, :so, :sq, :sr, :sw, :ta, :th, :tk, :tr, :uk, :ur, :uz, :vi, :zh]
